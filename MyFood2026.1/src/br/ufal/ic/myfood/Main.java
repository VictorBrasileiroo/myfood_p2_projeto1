...
public class Main {
    public static void main(String[] args) {
        ...
        EasyAccept.main(new String[] {"br.ufal.ic.myfood.Facade", "MyFood2026.1/tests/us3_2.txt"});
        EasyAccept.main(new String[] {"br.ufal.ic.myfood.Facade", "MyFood2026.1/tests/us4_1.txt"});
        EasyAccept.main(new String[] {"br.ufal.ic.myfood.Facade", "MyFood2026.1/tests/us4_2.txt"});
    }
}
